...
(function () {
  ...
  function safeSet(key, value) {
    try {
      ...
      // Ignore storage errors (private mode / blocked storage / file:// restrictions).
    }
  }

  // Read saved theme or default to light
  let currentTheme = safeGet("portfolio-theme") || "light";

  function applyTheme(theme) {
    currentTheme = theme;
    html.setAttribute("data-theme", theme);
    safeSet("portfolio-theme", theme);
    if (toggleBtn) {
      ...
      toggleBtn.setAttribute(
        "aria-label",
        theme === "light" ? "Switch to hacker theme" : "Switch to light theme",
      );
    }
  }
...
(function () {
  ...
  document
    .querySelectorAll("a, button, .project-card, .skill-category, .social-btn")
    .forEach((el) => {
